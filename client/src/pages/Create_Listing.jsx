  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.imageUrls.length < 1)
        return setError("upload atleat one image");
            ...
            {formData.offer && (
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs"> {formData.type ==='sale' ?'(₹)':'(₹ / month)'}</span>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80 shadow-md"
            >
          ...
          className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 shadow-md">
